import { posts, posts_images, footerDetails } from "./constants/constants";
      ...
      >
        ...
        <div className="flex flex-col items-center text-center gap-6">
          ...
          <p className="max-w-3xl text-xs text-gray-600 leading-relaxed">
            ...
            <Button
              variant="link"
              className="text-sofolRed text-xs px-1"
            >
              Read more
            </Button>
          </p>
        ...
        <div className="flex flex-col xl:flex-row gap-12 w-full justify-between">
          ...
          <div className="flex flex-col gap-6 max-w-lg w-full">
            <h1 className="font-semibold uppercase text-sofolBlack">
              About
            </h1>

            <p className="text-sm text-sofolBlack/75">
              We are Sofol, delivering innovative software solutions that
              empower businesses to grow, streamline operations, and
              achieve digital excellence across modern platforms...
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full">
              ...
              />
              <Button className="bg-sofolRed px-6 py-4">
                Subscribe
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 w-full max-w-md">
            ...
            {posts.map((post, i) => (
              <div
                key={i}
                className="flex gap-3 items-start max-w-full"
              >
                <img
                  src={post.image}
                  alt={post.title}
