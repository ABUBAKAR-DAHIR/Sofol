            ...
            <div className="shadow-lg p-8 my-4 w-200 rounded-xl max-[820px]:w-150 max-sm:w-80 max-sm:p-3">
                ...
                <div className="flex gap-4 justify-between w-full max-sm:w-full max-sm:flex-col max-sm:items-center max-sm:justify-center">
                    <form action="" className="flex flex-col mr-4 w-9/20 max-sm:w-full">
                        <input type="text" name="" id="" placeholder="first name and last name"  className="px-2 py-2.5 border-2 border-gray-600 rounded-sm my-1 text-xs"/>
                        <input type="email" name="" id="" placeholder="email" className="px-2 py-2.5 border-2 border-gray-600 rounded-sm my-1 text-xs" />
                        <textarea name="" id="" cols={4} rows={10} placeholder="your message" className="resize-none px-2 py-2.5 border-2 border-gray-600 rounded-sm my-1 text-xs"></textarea>
                    ...
                    <div className="w-9/20 max-sm:w-full">
                        <p className="flex gap-2 my-1 text-gray-700 cursor-pointer"><img src="/public/contact/phone.svg" alt="phone" width={15} height={15} /> +91-311-1234567</p>
                        <p className="flex gap-2 my-1 text-gray-700 cursor-pointer"><img src="/public/contact/email.svg" alt="email" width={15} height={15} /> myportfolio@gmail.com</p>
                        <p className="flex gap-2 my-1 text-gray-700 cursor-pointer"><img src="/public/contact/location.svg" alt="location" width={15} height={15} /> Address, Haryana, India</p>
