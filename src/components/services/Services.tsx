            ...
            <div className="grid grid-cols-3 mt-20 max-lg:flex max-lg:flex-wrap max-lg:items-center max-lg:justify-center">
                {
                    services.map((service, i) => (
                        <div key={i} className="size-85 flex flex-col items-center py-10 px-4 cursor-pointer rounded-xl  transition-shadow duration-300 hover:shadow-lg hover:shadow-gray-400/50">
