...
export default function Hero() {
  ...
  return (
    <section className='relative h-[calc(100vh-130px)] max-xl:h-[calc(100vh-80px)] bg-[url("/team-section/hero.png")] bg-cover bg-center bg-no-repeat overflow-hidden flex flex-col justify-center items-center text-center'>
